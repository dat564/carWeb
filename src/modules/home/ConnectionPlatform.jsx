    ...
    return (
        <div className='mb-10'>
            <h2 className='mt-10 mb-4'>
                Nền tảng kết nối người dùng và nhà ga
            </h2>
            <div className='flex gap-4'>
                <div className='rounded-md p-3 border border-[#858585] overflow-hidden flex gap-5'>
                    ...
                    <div>
                        <h3 className='mb-2'>2000+ nhà ga chất lượng cao</h3>
                        <p className='text-[#858585] text-sm'>
                            5000+ tuyến đường trên toàn quốc, chủ động và đa
                            dạng lựa chọn.
                        </p>
                    </div>
                </div>
                <div className='rounded-md p-3 border border-[#858585] overflow-hidden flex gap-5'>
                    ...
                    <div>
                        ...
                        <p className='text-[#858585] text-sm'>
                            Đặt vé chỉ với 60s. Chọn ga yêu thích cực nhanh và
                            thuận tiện.
                        </p>
                    </div>
                </div>
