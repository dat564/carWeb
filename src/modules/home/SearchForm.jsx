...
const SearchForm = ({ queryData = {} }) => {
  ...
  const handleGetCities = async () => {
    ...
    const results = data.map((city) => ({ label: city.province_name, value: city.province_name }));
    setCities(results);
  };
      ...
      <div className="w-full p-5 bg-white rounded-lg min-h-20">
        <Spin spinning={loading}>
          <ProForm
            ...
            initialValues={{
              ...queryData,
              date: queryData?.date ? moment(queryData?.date, 'DD/MM/YYYY') : moment()
            }}
            ...
            <div className="flex-1 flex items-center border border-[#eee] rounded-lg min-h-[50px] p-3 gap-4 w-full">
              <div className="flex items-center justify-center px-3 flex-1 gap-4 border-r border-[#eee]">
                ...
                <div className="flex flex-col justify-center flex-1 h-[30px]">
                  <span className="text-[#bbb] text-[12px] font-semibold">Nơi xuất phát</span>
                  <ProFormSelect
                    name="route_start"
                    fieldProps={{ ref: departmentPointRef, showAction: ['focus'], showSearch: true }}
                    options={cities}
                    id="route_start"
                    onChange={() => destinationPointRef.current.focus()}
              ...
              <div className="flex items-center justify-center flex-1 px-3 gap-4 border-r border-[#eee]">
                ...
                <div className="flex flex-col justify-center flex-1 h-[30px]">
                  <span className="text-[#bbb] text-[12px] font-semibold">Nơi đến</span>
                  <ProFormSelect
                    name="route_end"
                    fieldProps={{ ref: destinationPointRef, showAction: ['focus'], showSearch: true }}
              ...
              <div className="flex items-center justify-center w-[300px] gap-4 px-4">
                ...
                <div className="flex flex-col justify-center flex-1 h-[30px]">
                  <span htmlFor="test" className="text-[#bbb] text-[12px] font-semibold">
                    Ngày đi
                  </span>
                  <ProFormDatePicker
                    name="date"
