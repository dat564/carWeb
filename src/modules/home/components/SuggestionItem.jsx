    ...
    return (
        <div className='w-[230px] h-[230px] rounded-md overflow-hidden bg-[#9e947c] text-white cursor-pointer'>
            ...
            <div className='p-3'>
                <h3 className='mb-2'>
                    00:00 - 00:00
                    {/* {removeProvinceCityPrefix(data?.route_start)} -{" "}
                    {removeProvinceCityPrefix(data?.route_end)} */}
                </h3>
                <p className='flex items-center gap-2 text-sm'>
                    <span>Từ 120.000đ</span>
                    <span className='line-through text-[#ffffff99] text-xs'>
                        300.000đ
                    </span>
                </p>
            </div>
