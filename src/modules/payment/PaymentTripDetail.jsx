                ...
                title={
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-2'>
                            ...
                            <span>
                                {/* { formatDate(convertDatetime(currentTrip?.trip?.departure_time)) } */}
                                20:00
                            </span>
                            <div className='flex items-center'>
                                <GroupOutlinedIcon className='text-gray-500' />
                                <span>
                                    {/* { currentTrip.tickets.length } */}2
                                </span>
                            </div>
                        </div>
                        <div>
                    ...
                    <div className='flex items-center gap-3 p-3 border-b border-gray-300'>
                        <div>
                            <Image
                                ...
                                // loader={() =>
                                //     `${image_url}${currentTrip.car.images}`
                                // }
                        ...
                        <div className='flex items-center gap-4 font-medium'>
                            <div className='flex flex-col gap-8 text-lg'>
                                <span>
                                    {/* {formatTime(
                                        convertDateAndFormat(
                                            currentTrip.trip.departure_time
                                        )
                                    )} */}
                                    00:00
                                </span>
