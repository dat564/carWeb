...
const content = (
    <div className='w-[500px]'>
        <p>
            ...
            báo với quý khách các thay đổi trước chuyến đi. Xin cảm ơn.
        </p>
    </div>
);
...
const TripItem = ({ tripData }) => {
    ...
    const transportCompany = useMemo(
        () => car?.transport_company,
        [car?.transport_company]
    );
    const tickets = useMemo(() => tripData?.tickets, [tripData?.tickets]);
    const breakPointSortasc = tripData?.break_point.sort(
                ...
                <div className='flex flex-col items-end justify-between'>
                    ...
                    <div className='flex text-lg'>
                        <Button
                            ...
                            type='link'
                            icon={
                                openDetail ? <DownOutlined /> : <UpOutlined />
                            }
